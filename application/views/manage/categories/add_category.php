...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?= ASSETSPATH ?>css/backend/bootstrap.min.css" rel="stylesheet">
	...
	<script src="<?= ASSETSPATH ?>js/backend/jquery.js"></script>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">CT Admin</a>
            </div>
            <!-- Top Menu Items -->
